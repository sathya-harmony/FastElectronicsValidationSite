...
import { stores, products, offers, categories } from "@/lib/mockData";
...
export default function StorePage() {
  ...
  }).filter(item => item.product !== undefined) as {product: typeof products[0], offer: typeof offers[0]}[];
        ...
        <div className="h-48 md:h-64 bg-slate-900 relative overflow-hidden">
           ...
           <div className="container mx-auto px-4 h-full flex items-end pb-8 relative z-10">
             <div className="flex flex-col md:flex-row items-start md:items-end gap-6">
               <div className="h-24 w-24 md:h-32 md:w-32 bg-white rounded-xl shadow-lg p-2 -mb-12 md:mb-0 border-4 border-background">
